  ...
  <div class="container">
   ...
   <div class="section">
      ...
      <div class="row">
        ...
        <a class="btn btn-floating btn-flat" style="border-top-width: 15px;margin-top: 18px;margin-left: 5px;">
    ...
    <table>
        ...
        <tbody>
          <tr>
            ...
            <td>https://rdu.unc.edu.ar/oai/request</td>
            <td>DC</td>
            <td><a class="btn btn-floating btn-flat"><i class="small material-icons red darken-4">delete</i></a></td>

          </tr>
          <tr>
            <td>2</td>
            <td>Universidad de Cordoba</td>
            <td>http://nulan.mdp.edu.ar/cgi/oai2/request </td>
            <td>DC</td>
             <td><a class="btn btn-floating btn-flat"><i class="small material-icons red darken-4">delete</i></a></td>
          </tr>
          <tr>
            <td>3</td>
            <td>Universidad de Cordoba</td>
            <td>http://miunespace.une.edu.ve/oai/request</td>
            <td>DC</td>
            <td><a class="btn btn-floating btn-flat"><i class="small material-icons red darken-4">delete</i></a></td>
          </tr>
        </tbody>
